...
ROLE_PERMISSION_MATRIX: list[dict[str, Any]] = [
    {
        "role": Role.METADATA_STEWARD.value,
    ...
    },
    {
        ...
        "can_resolve_policy_ambiguities": False,
        "scope": "Assigned human casework only; cannot alter policy, facts, or original decision traces.",
    },
    {
        "role": Role.RULE_AUTHOR.value,
        "label": "Policy author",
        "can_quick_edit": False,
    ...
    },
    {
        ...
        "can_manage_decision_reviews": False,
        "can_resolve_policy_ambiguities": False,
        "scope": "Immutable releases after separation-of-duties checks.",
    },
    {
