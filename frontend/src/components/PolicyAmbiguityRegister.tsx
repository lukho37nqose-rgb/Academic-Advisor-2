...
export function PolicyAmbiguityRegister({
  ...
  return <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 py-4">
    ...
    {canRecord && <section className="grid gap-4 border-b border-border pb-6">
    ...
    {!canRecord && !canResolve && <p className="border-l-2 border-border pl-3 text-sm text-muted">This account may inspect policy interpretations but cannot record or resolve them.</p>}
